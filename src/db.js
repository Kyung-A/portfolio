export const projectList = [
  {
    ...
    descriptionList: [
      ...
      {
        item: '데이터 시각화 서비스 React, TypeScript 환경 UI, 프론트 개발',
      },
      {
        item: '기존 React로 구성된 핵심 데이터 시각화 서비스를 Java로 옮기기 위한 작업 진행중',
      },
    ],
  ...
  },
  {
    ...
    descriptionList: [
      ...
      { item: '데이터 시각화, 지도 서비스, 그 외 페이지 React UI 개발' },
      {
        item: '데이터 차트 시각화관련 React UI, 프론트 개발',
      },
      {
        item: 'POI 관리자 화면 JSP UI 개발',
      },
    ],
    url: null,
  },
  {
    ...
    descriptionList: [
      ...
      { item: '메인화면, 우리마을지도, 상권분석, 제로페이 React UI 개발' },
      {
        item: 'Java 기반의 POI 관리자 화면 JSP UI 개발',
      },
    ],
    url: null,
  },
  {
    ...
    descriptionList: [
      ...
      { item: 'HTML, CSS 퍼블리싱 작업' },
      {
        item: '계속 되는 디자인, 레이아웃 수정 요청으로인한 CSS 모듈화에 신경을 많이 쓴 프로젝트',
      },
    ],
    url: null,
  },
...
export const studyList = [
  {
    ...
    description: '과연 어떤게 최선의 파일 구조일까? 주절주절 고민을 써봤다.',
  ...
  },
  {
    ...
    description: 'V6의 등장! 전 버전인 V5와의 차이점을 알아보자.',
  ...
  },
  {
    ...
    description: 'CSS만 잘 써도 협업때 서로서로 매우 편안해진다.',
  ...
  },
  {
    ...
    description: '토이 프로젝트 에러 보고서. 오기로 해결헸다.',
  ...
  },
  {
    ...
    description: '입사 초기에 고민했던 부분을 해결하다.',
